...
class Logger:
    ...
    @staticmethod
    def log(message: str, level: Level_en=Level_en.INFO, content: str="", file_name:str=random.getrandbits(MAX_LOG_HASH_FILENAME_SIZE), folder_path=LOG_FOLDER_PATH, to_std_out:bool=PRINT_TO_STDOUT):
